 ...
 *       add_submenu_page( CARACOOL_MENU_SLUG, 'Nombre', 'Nombre',
 *           'manage_options', 'slug-del-plugin', array( $this, 'render' ) );
 *   } );                                   // prioridad 10, por defecto
 *
 *   add_filter( 'caracool_plugins', function ( $l ) {
 *       $l[] = array( 'nombre' => 'Nombre', 'pagina' => 'slug-del-plugin',
 *                     'version' => CONSTANTE_VERSION,
 *                     'resumen' => 'Una frase corta de qué hace.' );
 *       return $l;
 *   } );
 * ─────────────────────────────────────────────────────────────────────
 */
